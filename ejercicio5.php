...
if ($_POST) {
    ...
    if ($a == $b || $a == $c || $b == $c) {
        $mensaje = "Error: Los valores ingresados deben ser distintos.";
    } else {
        // Determinar el mayor
        if ($a > $b && $a > $c) {
            $mayor = $a;
        ...
        $mensaje = "El mayor es: $mayor<br>El menor es: $menor";
    }
}
?>


    <h1>Determinar el mayor y menor de tres valores</h1>
